...
public class sign_up extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		htmlBuilder2.append("<style> .button {color: white;} .round { border-radius: 0px 20px;} .round2 { border-radius: 0px 50px;} .collight{background-color:#48CFAD;} .coldark{background-color:#37BC9B;} </style>");
		htmlBuilder2.append("</head>");
		htmlBuilder2.append("<body class='coldark'> <br> <br><div class='container round collight'>");
