            ...
            <div class="portlet portlet-default">
                <div class="portlet-heading">
                    <div class="portlet-title">
                        <h3><i class="fa fa-circle text-green"></i> Chat Here</h3>
                    </div>
                        <span class="divider"></span>
                        <a  href="#chat"><i class="fa fa-chevron-down"></i></a>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="media">
                                    <div class="media-body">
                                        <h4 class="media-heading">Ayush Gandhi
                                            <span class="small pull-right">12:23 PM</span>
                                        </h4>
                                        <p>Hi, I wanted to make we have the chat app on time</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">Smeet Chheda
